...
$sqls[] = "ALTER TABLE  `photo_caches` CHANGE  `status`  `status` ENUM(  'queued',  'processing',  'ready',  'failed' ) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT  'queued'";
