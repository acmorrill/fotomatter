...
//		}
    ...
    public function get_extra_current_print_data($photo_sellable_print, $photo, $photo_override = false) {
        ...
        return compact('price', 'cost', 'short_side_inches', 'long_side_inches', 'long_side_feet_inches', 'short_side_feet_inches', 'sq_inches', 'type');
    }

    /**
     * This function is used by cart.php to get the data for a photo to add it to the cart
     * 
     * @param type $photo_id
     ...
     * @return type
     */
    public function get_extra_print_data($photo_id, $photo_print_type_id, $short_side_inches, $type) {
        ...
        foreach ($sellable_print_sizes as $key => $sellable_print_size) {
            if ($sellable_print_size['CurrentPrintData']['short_side_inches'] == $short_side_inches && $sellable_print_size['CurrentPrintData']['type'] == $type) {
