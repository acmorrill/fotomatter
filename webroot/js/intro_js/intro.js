...
//	console.log("====================");
		...
		if (!_elementInViewport(targetElement.element) && this._options.scrollToElement === true) {
			var rect = targetElement.element.getBoundingClientRect(),
					...
					top = rect.bottom - (rect.bottom - rect.top) - 250, // DREW TODO change this if header height changes  // -94 is so it will scroll past the header
	...
	function _elementInViewport(el) {
		...
		return (
				rect.top - 250 >= 0 && // DREW TODO change this if header height changes  // -94 is so it will scroll past the header
				rect.left >= 0 &&
