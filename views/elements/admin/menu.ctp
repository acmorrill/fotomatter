<ul id="top-navigation">
	...
	<li class='<?php if ($curr_page == 'e-commerce'): ?> curr<?php endif; ?>'><a href='/admin/ecommerces'><?php __("E-COMMERCE"); ?></a></li>
	...
	<li class='<?php if ($curr_page == 'site_settings'): ?> curr<?php endif; ?>'><a href='/admin/accounts'><?php __("SITE SETTINGS"); ?></a></li>
</ul>
