...
<div class="add_gallery_element add_element custom_ui">
	<select class="add_gallery_select" data-step="3" data-intro="<?php echo __('Standard Galleries allow you to choose photos to put into the gallery manually. Smart galleries automatically add photos based on settings such as upload date, tags and photo format.', true); ?>" data-position="left">
