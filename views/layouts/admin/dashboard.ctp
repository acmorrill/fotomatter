...
<html>
<head>
	<?php echo $this->Element('admin/meta_and_tags/title', array('layout_default' => 'Dashboard')); // can also $title_for_layout in the controller ?>
...
<div id="main">
	<div id="header">
		...
		<?php echo $this->Element('admin/menu', array( 'curr_page' => 'dashboard' )); ?>
	</div>
