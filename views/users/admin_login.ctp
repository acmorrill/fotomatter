...
<div class='generic_palette_container'>
	...
	<form action="/admin/users/login" id="UserLoginForm" method="post" accept-charset="utf-8">
		...
		<div class="input text">
			...
			<input name="data[User][email_address]" type="text" class="text defaultText" maxlength="127" id="UserEmailAddress" title='john@example.com'>
		</div>
	...
	<form id='forgot_password_form' action="/users/request_admin_password_change" method="post">
		<div class="input">
			...
			<input title='john@example.com' name="data[User][forgot_password_email]" type="text" class="text defaultText" maxlength="127" />
		</div>
		<div class="submit custom_ui">
			<div class="add_button javascript_submit">
				<div class="content"><?php echo __('Send Change Password Email', true); ?></div>
				<div class="right_arrow_lines"><div class=""></div></div>
			</div>
		</div>
		<div class="hide_submit">
