...
<div class="table_container" data-step="1" data-step="1" data-intro="<?php echo __('This pages displays all the orders that have been place to your account.', true); ?>" data-position="top">
