<div id="footer_tagline">
	...
	<div class="footer_tagline_container_outer">
		<div class="footer_tagline_container_inner">
			...
			<div class="powered_by" <?php if ($hide_fotomatter_link): ?>style="display: none;"<?php endif; ?> ><span>Powered by </span><a href="https://www.fotomatter.net" target="_blank"><span>fotomatter.net</span><img class="fotomatter_logo" src="<?php echo $this->Util->global_cdn('fotomatter_footer_logo.svg'); ?>" /></a></div>
		</div>
	</div>
</div>