...
<div class="site_element para_header_image_page_element_cont <?php echo $config['para_image_header_image_pos']; ?>">
	...
	<?php if (isset($config['para_header_image_photo_id']) && $config['para_header_image_photo_id'] != -1): ?>
		<img class='<?php echo $config['para_image_header_image_pos']; ?>' src="<?php echo $this->Photo->get_photo_path($config['para_header_image_photo_id'], $para_image_size, $para_image_size); ?>" style="<?php echo $css; ?>" />
	<?php endif; ?>
