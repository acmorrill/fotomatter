...
<?php if ( $is_home || $not_home_and_starts_with ): ?>
	<li class="<?php echo implode(' ', explode('|', $li_class)); ?> hover highlight last_hover" style="<?php echo $style; ?>" ><span class="cart_item_content"><?php echo $menu_item_data['name_html']; ?><?php echo str_replace(' ', '&nbsp;', $menu_item_data['name']); ?></span><span class="extra"></span></li>
<?php else: ?>
