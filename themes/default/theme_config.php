		...
		'theme_avail_custom_settings' => array(
			'settings' => array(
				'global_settings_group' => array( // all global theme settings should start with "global_" so they are sorted correctly
					'type' => 'group_name',
					'display_name' => 'Global Theme Settings &mdash; settings apply to all themes',
				),
				...
				'global_last_name' => array(
					...
					'description' => "The last name that is used in auto generated logos and content on your website. Value cannot be empty.",
				...
				'global_company_or_tagline' => array(
					...
					'description' => "The company name or tagline that is used in auto generated logos and content on your website. Value cannot be empty. Not all themes use this setting.",
					'possible_values' => ".*\\\S+.*", // can be regex -- this is only non empty
					'default_value' => '',
				...
				'global_photo_page_add_to_cart_text' => array(
					...
					'description' => "Above the “Add to Cart” button, there will be a list of print types you offer (ie canvas, paper, metal, etc.). The default title for your print type options will be “Print Types.” Here you can change the title.",
					'possible_values' => ".*\\\S+.*", // can be regex -- this is only non empty
					'default_value' => 'Print Types',
				),
				'global_frontend_checkout_thankyou_page_text' => array(
					'type' => 'textarea',
					'display_name' => 'Thank You Page Text',
					'description' => "This is the text your customers will see after they are done purchasing. Write your own text &mdash; it will save automatically.",
