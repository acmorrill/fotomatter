	...
	<body>
		...
		<div class="galleryContent">
			...
			<div class="portfolioLinks">
				...
				<a onmouseover="setImage('/portfolioThumb', 'photos/portfolioThumbs/A-Tangerine-Blue.jpg');" href="gallery.php?gallery=largeFormatColor">Color Landscapes</a><br />
				<a onmouseover="setImage('/portfolioThumb', 'photos/portfolioThumbs/Celestial-ArrayBW.jpg');" href="gallery.php?gallery=largeFormatBW">Black &amp; White Landscapes</a><br />
				<a onmouseover="setImage('/portfolioThumb', 'photos/portfolioThumbs/Solar-Migrations.jpg');" href="gallery.php?gallery=panoramics">Panoramic Landscapes</a><br />
				<a onmouseover="setImage('/portfolioThumb', 'photos/portfolioThumbs/Provo-Temple-Winter.jpg');" href="gallery.php?gallery=temples">LDS Temple Pictures</a><br />
				<!--<a onmouseover="setImage('portfolioThumb', 'photos/portfolioThumbs/Winter-Berries.jpg');" href="gallery.php?gallery=digitalIdeas">Other</a><br />-->
				<!--<a onmouseover="setImage('portfolioThumb', 'photos/portfolioThumbs/Passing-Rain.jpg');" href="gallery.php?gallery=noPano">All Images</a><br />-->
				<br/><br/><br/>
			</div>
			<br />
