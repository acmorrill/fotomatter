(function(a){function b(a){return"object"==typeof a?a:{top:a,left:a}}var d=a.scrollTo=function(b,d,c){a(window).scrollTo(b,d,c)};d.defaults={axis:"xy",duration:1.3<=parseFloat(a.fn.jquery)?0:1,limit:!0};d.window=function(b){return a(window)._scrollable()};a.fn._scrollable=function(){return this.map(function(){if(this.nodeName&&-1==a.inArray(this.nodeName.toLowerCase(),["iframe","#document","html","body"]))return this;var b=(this.contentWindow||this).document||this.ownerDocument||this;return/webkit/i.test(navigator.userAgent)||
"BackCompat"==b.compatMode?b.body:b.documentElement})};a.fn.scrollTo=function(e,f,c){"object"==typeof f&&(c=f,f=0);"function"==typeof c&&(c={onAfter:c});"max"==e&&(e=9E9);c=a.extend({},d.defaults,c);f=f||c.duration;c.queue=c.queue&&1<c.axis.length;c.queue&&(f/=2);c.offset=b(c.offset);c.over=b(c.over);return this._scrollable().each(function(){function g(a){n.animate(h,f,c.easing,a&&function(){a.call(this,e,c)})}if(null!=e){var m=this,n=a(m),l=e,p,h={},t=n.is("html,body");switch(typeof l){case "number":case "string":if(/^([+-]=)?\d+(\.\d+)?(px|%)?$/.test(l)){l=
b(l);break}l=a(l,this);if(!l.length)return;case "object":if(l.is||l.style)p=(l=a(l)).offset()}a.each(c.axis.split(""),function(a,b){var e="x"==b?"Left":"Top",f=e.toLowerCase(),k="scroll"+e,q=m[k],r=d.max(m,b);p?(h[k]=p[f]+(t?0:q-n.offset()[f]),c.margin&&(h[k]-=parseInt(l.css("margin"+e))||0,h[k]-=parseInt(l.css("border"+e+"Width"))||0),h[k]+=c.offset[f]||0,c.over[f]&&(h[k]+=l["x"==b?"width":"height"]()*c.over[f])):(e=l[f],h[k]=e.slice&&"%"==e.slice(-1)?parseFloat(e)/100*r:e);c.limit&&/^\d+$/.test(h[k])&&
(h[k]=0>=h[k]?0:Math.min(h[k],r));!a&&c.queue&&(q!=h[k]&&g(c.onAfterFirst),delete h[k])});g(c.onAfter)}}).end()};d.max=function(b,d){var c="x"==d?"Width":"Height",g="scroll"+c;if(!a(b).is("html,body"))return b[g]-a(b)[c.toLowerCase()]();var c="client"+c,m=b.ownerDocument.documentElement,n=b.ownerDocument.body;return Math.max(m[g],n[g])-Math.min(m[c],n[c])}})(jQuery);
(function(a){a.fn.endlessScroll_horizontal=function(b){b=a.extend({},{bottomPixels:50,fireOnce:!0,fireDelay:150,loader:"<br />Loading...<br />",data:"",insertAfter:"div:last",resetCounter:function(){return!1},callback:function(){return!0},ceaseFire:function(){return!1},intervalFrequency:250},b);var d=!0,e=!1,f=0,c=!1,g=this,m="";a(".endless_scroll_inner_wrap",this);var n;a(this).scroll(function(){c=!0;g=this;m=a(g).attr("id")});setInterval(function(){c&&!0===d&&(c=!1,!0===b.ceaseFire.apply(g,[f])?
d=!1:(n=g==document||g==window?a(document).width()-a(window).width()<=a(window).scrollLeft()+b.bottomPixels:jQuery(g).scrollLeft()+jQuery(g).width()>jQuery(g)[0].scrollWidth-b.bottomPixels)&&(0==b.fireOnce||1==b.fireOnce&&1!=e)&&(!0===b.resetCounter.apply(g)&&(f=0),e=!0,f++,a(b.insertAfter).after('<div class="endless_scroll_loader_'+m+' endless_scroll_loader">'+b.loader+"</div>"),data="function"==typeof b.data?b.data.apply(g,[f]):b.data,!1!==data&&(a(b.insertAfter).after('<div id="endless_scroll_data">'+
...
function get_current_middle_image(){var a=jQuery(document).width()/2,b=void 0,d=void 0;jQuery("#white_slider_listing_actual_container img:not(.blank)").each(function(){var e=jQuery(this).offset().left+jQuery(this).width()/2,f=jQuery(this).offset().left,c=jQuery(this).offset().left+jQuery(this).width();if(f<=a&&c>=a)return b=jQuery(this),d={},d.current_middle_image=b,d.current_middle=e,!1});return d}
function move_to_next_prev_image(a){"left"!=a&&"right"!=a&&(a="right");var b=jQuery(document).width()/2,d=get_current_middle_image(),e=void 0,e=Math.abs(b-d.current_middle),f=.1*d.current_middle_image.width(),e="right"==a?d.current_middle>b&&e>f?d.current_middle_image:d.current_middle_image.next():d.current_middle<b&&e>f?d.current_middle_image:d.current_middle_image.prev();if("undefined"==typeof e||"undefined"==e.attr("photo_id"))e="right"==a?jQuery("#white_slider_listing_actual_container img:not(.blank)").last():
jQuery("#white_slider_listing_actual_container img:not(.blank)").first();"undefined"!=e&&0<e.length&&!e.hasClass("blank")&&(a=jQuery("#white_slider_listing_actual_container").scrollLeft()+e.offset().left+e.width()/2,b=Math.round(a-b),jQuery("#white_slider_listing_actual_container").scrollLeft(b),calculate_scroll_control_div_width_and_pos(),calculate_control_container_scroll(),b=jQuery("#white_slider_listing_actual_container img:not(.blank)").last(),"undefined"!=b&&0<b.length&&b[0]===e[0]&&endless_scroll_callback())}
